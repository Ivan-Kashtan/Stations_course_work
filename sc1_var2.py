...
r_e = r_n_e * r_b[1] / (r_n_e + r_b[1])
r_s = r_b[0] * (r_at_e + r_e) / (r_b[0] + r_at_e + r_e)

e_e = array([e_g, (e_g * x_n_e[1] + e_n * x_b[1, 0]) / (x_n_e[1] + x_b[1, 0])])
e_s = (e_e[0] * (x_at_e + x_e[1]) + e_e[1] * x_e[0]) / (x_e + x_at_e + x_e[0])

I_sc_3 = array([e_e[0] / x_e[1] * i_b[1], e_e[1] / x_at_e * i_b[1]])
# '''
I_sc_3_s = sum(I_sc_3)
t_a = x_s[0] / (omega * r_s)
k_s = 1 + e**(-0.01 / t_a)
...
e_e = array([e_g, (e_g * x_n_e[1] + e_n * x_b[1, 0]) / (x_n_e[1] + x_b[1, 0])])
e_e = 
e_s = (e_e[0] * (x_at_e + x_e[0]) + e_e[1] * x_e11[0]) / (x_e11[0] + x_at_e + x_e2[0])

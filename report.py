...
f = [KeepTogether([mn, t_u, un, s_80, kaf, s_80, tp, title, var, s_120, fac, gr, st, tchr, mk, s_120, sity]),
     ...
     img(f'${{P\'}}_{{Г_ном}} = (1-k_{{с.н.}})P_{{Г_ном}}; \\quad '
     ...
     img(f'${{Q\'}}_{{Г_ном}} = (1-k_{{с.н.}})P_{{Г_ном}}; \\quad '
         f'{{Q\'}}_{{Г_ном}} = {1-k_s_n:.2f} \\cdot {q_g:.1f} = {q_g_:.1f}$ Мвар'),
     Paragraph('Номинальная полная мощность агрегатов с вычетом мощности с.н. ', style=st_0_10),
     img(f'${{S\'}}_{{Г_ном}} = (1-k_{{с.н.}})S_{{Г_ном}}; \\quad '
         f'{{S\'}}_{{Г_ном}} = {1-k_s_n:.2f} \\cdot {s_g} = {s_g_:.1f}$ МВ\u00B7А'),
     Paragraph('Выбор трансформаторов блоков по номинальной мощности осуществляется по условию:', style=s_f_10),
     img(f'$S_{{ТБ}} \u2265 {{S\'}}_{{Г_ном}} = {s_g_:.1f}$'),
     Paragraph('Выбор трансформаторов блоков по номинальной мощности осуществляется по условию:', style=st_15_5),

...
f = [KeepTogether([mn, t_u, un, s_80, kaf, s_80, tp, title, var, s_130, fac, gr, st, tchr, mk, s_130, sity]),
     ...
     Paragraph('К стороне СН подключено 4 генератора, к автотрансформаторам связи генераторы не подключены.',
               style=st_0_10),
     Image(r'C:\Users\kasht\Documents\Учёба\6 семестр\Станции\Курсовая\Компас\Схемы\2 вар. из примера (3).png',
           width=15*cm, height=10*cm, kind='proportional'),
     ...
     Paragraph('В качестве окончательного выбираем 2-й вариант структурной схемы: к стороне СН подключено '
               ...
               st_0_3),
     Paragraph('Выбор трансформаторов блока', st_b_5_0),
     ...
     Paragraph('Выбор линий связи с энергосистемой', st_b_5_0),
     ...
     fml(f'$S_{{C_\u0020 max}} = \\sqrt{{P_{{C_\u0020 max}}^2 + Q_{{C_\u0020 max}}^2}}; \\quad'
         f'S_{{C_\u0020 max}} = \\sqrt{{{ln.p}^2 + {ln.q}^2}}$ МВ\u00B7А'),
     Paragraph('Минимальное сечение проводов по условиям короны и радиопомех для ВЛ '
               'номинальным напряжением 750 кВ составляет 4\u002a400 или 5\u002a240, '
               'фаза с 2-мя и более проводами', st_0_3),
     ...
     Paragraph('Ток в каждом из 4-х расщепленных проводов', st_0_3),
     fml(''),
     Paragraph('Принимаем 3 линии связи с проводом 4\u002a400', st_0_3),

...
f = [KeepTogether([mn, t_u, un, s_80, kaf, s_80, tp, title, var, s_130, fac, gr, st, tchr, mk, s_130, sity]),
     ...
     fml(f'$Q_4 = Q_{{нг_\u0020 л_\u0020 max}} - \\left (N_1 - 2 \\right) '
         ...
         f'Q_4 = {q_ld_min_sm:.1f} - {n1 - 2} \\cdot {q_g_:.1f} + {q_s_n:.1f} = {v1.q4:.1f}$ МВар'),
     sp_25,
     ...
     fml(f'$Q_4 = Q_{{нг_\u0020 л_\u0020 max}} - \\left (N_1 - 2 \\right) '
         f'{{Q\'}}_{{г_\u0020 ном}} + 2Q_{{с.н.}}; \\quad'
         f'Q_4 = {q_ld_min_sm:.1f} - {v2.n1_c - 2} \\cdot {q_g_:.1f} + {q_s_n:.1f} = {v2.q4:.1f}$ МВар'),
     sp_20,
...
Paragraph('Вариант 3', style=st_i_10_5),
     ...
     fml(f'$P_1 = \\dfrac {{P_{{изб_\u0020max}}}} {{2}} + {{P\'}}_{{г_\u0020ном.}}; \\quad'
         f'P_1 = \\dfrac {{{v3.p1:.1f}}} {{2}} + {{{p_g:.1f}}}; = {v3.p1:.1f}$ МВт'),
     sp_15,
     ...
     Paragraph('Аварийное отключение одного из автотрансформаторов связи при максимальном избытке мощности '
               'на стороне СН', style=st_0_10),
     fml(f'$P_2 = P_{{изб_\u0020max}} + 2 P\'_{{г_\u0020 ном}} - P_{{ав._\u0020рез.}}; \\quad P_2 = {v3.p1:.1f} + 2\\cdot '
         f'{p_g_}- {p_r} = {v3.p2:.1f}$ МВт'),
     sp_15,
     fml(f'$Q_2 = Q_{{изб_\u0020max}} - P_{{ав._\u0020рез.}} \\tan(\\phi_{{г_\u0020ном}}); \\quad'

...
t_u = Paragraph('Федеральное государственное бюджетное образовательное учреждение \n высшего образования', style=s_c_t)
...
title = Paragraph('Проектирование электрической части КЭС 5600 МВт', style=s_c_t_b)
...
tchr = Paragraph('Преподаватель: Купарев М.А.', style=s_l)
